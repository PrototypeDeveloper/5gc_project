...
type ApiHandleFunctions struct {
	...
	// Routes for the NSSAIAvailabilityStoreAPI part of the API
	...
	return []Route{ 
		{
			...
			handleFunctions.NFInstanceIDDocumentAPI.NSSAIAvailabilityDelete,
		},
		{
			"NSSAIAvailabilityPatch",
			http.MethodPatch,
			"/nnssf-nssaiavailability/v1/nssai-availability/:nfId",
			handleFunctions.NFInstanceIDDocumentAPI.NSSAIAvailabilityPatch,
		},
		{
			"NSSAIAvailabilityPut",
			http.MethodPut,
			"/nnssf-nssaiavailability/v1/nssai-availability/:nfId",
			handleFunctions.NFInstanceIDDocumentAPI.NSSAIAvailabilityPut,
		},
		{
			"NSSAIAvailabilityOptions",
			http.MethodOptions,
			"/nnssf-nssaiavailability/v1/nssai-availability",
			handleFunctions.NSSAIAvailabilityStoreAPI.NSSAIAvailabilityOptions,
		},
		{
			"NSSAIAvailabilitySubModifyPatch",
			http.MethodPatch,
			"/nnssf-nssaiavailability/v1/nssai-availability/subscriptions/:subscriptionId",
			handleFunctions.SubscriptionIDDocumentAPI.NSSAIAvailabilitySubModifyPatch,
		},
		{
			"NSSAIAvailabilityUnsubscribe",
			http.MethodDelete,
			"/nnssf-nssaiavailability/v1/nssai-availability/subscriptions/:subscriptionId",
			handleFunctions.SubscriptionIDDocumentAPI.NSSAIAvailabilityUnsubscribe,
		},
		{
			"NSSAIAvailabilityPost",
			http.MethodPost,
			"/nnssf-nssaiavailability/v1/nssai-availability/subscriptions",
			handleFunctions.SubscriptionsCollectionAPI.NSSAIAvailabilityPost,
		},
	}
}
