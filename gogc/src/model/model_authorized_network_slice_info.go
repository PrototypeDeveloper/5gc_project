...
type AuthorizedNetworkSliceInfo struct {
	...
	TargetAmfSet string `json:"targetAmfSet,omitempty" validate:"regexp=^[0-9]{3}-[0-9]{2,3}-[A-Fa-f0-9]{2}-[0-3][A-Fa-f0-9]{2}$"`
	...
	SnssaiInfoRspData map[string]SnssaiInfo `json:"snssaiInfoRspData,omitempty"`
}
