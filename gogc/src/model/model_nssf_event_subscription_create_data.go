...
type NssfEventSubscriptionCreateData struct {
	...
	AdditionalEvents []NssfEventType `json:"additionalEvents,omitempty"`

	// string with format 'date-time' as defined in OpenAPI.
	Expiry time.Time `json:"expiry,omitempty"`

	AmfSetId string `json:"amfSetId,omitempty" validate:"regexp=^[0-9]{3}-[0-9]{2,3}-[A-Fa-f0-9]{2}-[0-3][A-Fa-f0-9]{2}$"`
	...
	NsrpSubscribeInfo SnssaiReplacementSubscribeInfo `json:"nsrpSubscribeInfo,omitempty"`

	NsiunSubscribeInfo NsiUnavailabilitySubscribeInfo `json:"nsiunSubscribeInfo,omitempty"`

	ValidityTimeSubList []Snssai `json:"validityTimeSubList,omitempty"`
}
